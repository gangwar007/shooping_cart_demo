...
List<Products> productResponseFromJson(String str) =>
    List<Products>.from(
        json.decode(str).map((x) => Products.fromJson(x)));

String productResponseToJson(List<Products> data) => json
    .encode(List<Products>.from(data.map((x) => x.toJson())));